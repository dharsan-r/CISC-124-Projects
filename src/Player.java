...
public class Player {
     ...
     *
     * @param chips the integer which contains the amount of chips a player will start with
     */
    ...
    /**
     *Initializes a new player object nd sets a default chip, a coin face, and a name
     *
     * @param chips the integer which contains the amount of chips a player will start with
